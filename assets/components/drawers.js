	...
	if(credentials === null){
		...
		return (
            ...
            >
					...
					} resizeMode="contain" style={{width: 120, height: 120, borderRadius: 200 / 2, marginBottom: 20, borderColor: theme == 'light' ? COLORS.darkgray : COLORS.lightgray, borderWidth: 2}} />
            ...
            <View style={stylesLight.drawerButtonsContainer}>
              	...
              	<View style={{marginTop: 40}}>
                	<TouchableOpacity onPress={() => setGiftShow(!gitfShow)} style={{flexDirection: 'row'}}>
                  	<FontAwesome5 name="gifts" size={16} color={theme == 'light' ? COLORS.blue : COLORS.lightText} style={{paddingRight: 20}} />
                  	<Text style={theme == 'light' ? stylesLight.linkText : stylesDark.linkText}>Gifts</Text>
							<FontAwesome5 name="caret-down" size={16} color={theme == 'light' ? COLORS.blue : COLORS.lightText} style={{paddingRight: 20}} />
                	</TouchableOpacity>
              	</View>
              	{gitfShow && 
						<View style={{padding: 10}}>
							<View style={{marginTop: 10, padding: 10}}>
								<TouchableOpacity onPress={() => router.push('/dashboard/gifts')} style={{flexDirection: 'row'}}>
									<FontAwesome5 name="gifts" size={14} color={theme == 'light' ? COLORS.blue : COLORS.lightText} style={{paddingRight: 20}} />
									<Text style={[theme == 'light' ? stylesLight.linkText : stylesDark.linkText, {fontSize: 14}]}>All Gifts</Text>
								</TouchableOpacity>
							</View>
							<View style={{marginTop: 20, padding: 10}}>
								<TouchableOpacity onPress={() => router.push('/dashboard/gifts/addgifts')} style={{flexDirection: 'row'}}>
									<FontAwesome name="gift" size={16} color={theme == 'light' ? COLORS.blue : COLORS.lightText} style={{paddingRight: 20}} />
									<Text style={[theme == 'light' ? stylesLight.linkText : stylesDark.linkText, {fontSize: 14}]}>Add Gifts</Text>
								</TouchableOpacity>
							</View>
							<View style={{marginTop: 20, padding: 10}}>
								<TouchableOpacity onPress={() => router.push('/dashboard/gifts/mygifts')} style={{flexDirection: 'row'}}>
									<Ionicons name="md-gift-sharp" size={16} color={theme == 'light' ? COLORS.blue : COLORS.lightText} style={{paddingRight: 20}} />
									<Text style={[theme == 'light' ? stylesLight.linkText : stylesDark.linkText, {fontSize: 14}]}>My Gifts</Text>
								</TouchableOpacity>
							</View>
						</View>
					}
