...
const AllGifts = () => {
   ...
   const fetchGifts = () => {
      const url = 'https://heirtous.com/api/gifts';
		...
		formData.append('query', 'getgifts');
   ...
   return (
      ...
      >
         ...
         <SafeAreaView style={theme == 'light' ? stylesLight.page : stylesDark.page}>
			   ...
			   <View>
					<Text style={{textAlign: 'left', fontFamily: 'DMMedium', fontSize: 18, color: theme == 'light' ? COLORS.darkgray : COLORS.lightgray}}>All Gifts</Text>
				</View>
	...
	return (
		<View style={{paddingHorizontal: 2, paddingVertical: 9}}>
			<View style={theme == 'light' ? stylesLight.giftContainer : stylesDark.giftContainer}>
				...
				<View>
					<TouchableOpacity onPress={() => router.push({pathname: `/dashboard/gifts/gift/${item.gift_id}`, params: {gift_id: item.gift_id}})}>
